...
FGameplayAbilityInfo::FGameplayAbilityInfo(float CD, ECostType CostType, float CostValue, UMaterialInstance* IconMaterial, TSubclassOf<UGameplayAbility> AbilityClass):
	CD(CD),
	CostType(CostType),
	CostValue(CostValue),
