...
public:	
	...
	void OnHealthAttributeChange(const FOnAttributeChangeData& Data);
	
	void OnMPAttributeChange(const FOnAttributeChangeData& Data);
	
	void OnStrengthAttributeChange(const FOnAttributeChangeData& Data);
